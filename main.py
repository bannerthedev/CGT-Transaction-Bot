...
# ---------------- CONFIG (fill these) ----------------
GUILD_ID = 1487341502727323689  # your guild/server ID

# channels
# channels
TRANSACTIONS_ID = 1495048140892405890
MATCH_TIMES_CHANNEL_ID = 1487437824381948065
ASSIGNMENTS_CHANNEL_ID = 1501423405117739108
SCRIM_CATEGORY_ID = 0  # put your Scheduling category ID here, or 0 to create/use none
MATCH_SCORES_CHANNEL_ID = 1487438174291759368  # put your match-score channel ID here

# staff/team roles
CAPTAIN_ROLE_ID = 1487464830561681438
CO_CAPTAIN_ROLE_ID = 1487464877529239614
EXECUTIVE_ROLE_ID = 1505003910467686400
TEAM_PLAYER_ROLE_ID = 1501423770185760908

# assignment roles
HEAD_REF_ROLE_ID = 1505004072896299039
REF_ROLE_ID = 1487427478216769699
HEAD_CASTER_ROLE_ID = 1505004116441563266
CASTER_ROLE_ID = 1487427432360181892
# ----------------------------------------------------
...
async def admin_info(interaction: discord.Interaction):
    ...
    embed = discord.Embed(
        title="CGL Transactions Bot – Admin Command Guide",
